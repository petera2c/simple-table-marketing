...
function QuickStartPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuickStartPage.useEffect": ()=>{
            fetch("/txt-demos/QuickStartDemo.txt").then({
                "QuickStartPage.useEffect": (res)=>res.text()
            }["QuickStartPage.useEffect"]).then({
                "QuickStartPage.useEffect": (text)=>{
                    console.log("Fetched code:", text);
                    setDemoCode(text);
                }
            }["QuickStartPage.useEffect"]).catch({
                "QuickStartPage.useEffect": (err)=>console.error("Fetch Error:", err)
            }["QuickStartPage.useEffect"]);
        }
    }["QuickStartPage.useEffect"], []);
...
_s(QuickStartPage, "ijiqWxKjpEyPpJj4gqSIq6JVV8w=");
_c = QuickStartPage;
var _c;
...
//# sourceMappingURL=src_e0b0c632._.js.map