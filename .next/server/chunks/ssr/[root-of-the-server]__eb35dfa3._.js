...
async function getAllBlogPosts() {
    ...
    const posts = await Promise.all(files.map(async (filename)=>{
        ...
        const { data: data1, content: content1 } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gray$2d$matter$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])(source);
        return {
            ...
            tags: data1.tags || [],
            content: content1,
            readingTime: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$reading$2d$time$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateReadingTime"])(content1),
...
const BlogPage = async ()=>{
    ...
    const [filteredPosts, setFilteredPosts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchPosts = async ()=>{
            const allPosts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$blog$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllBlogPosts"])();
            setPosts(allPosts);
        };
        fetchPosts();
    }, []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setFilteredPosts(posts.filter((post)=>post.title.toLowerCase().includes(searchQuery.toLowerCase()) || post.description.toLowerCase().includes(searchQuery.toLowerCase()) || post.tags.some((tag)=>tag.toLowerCase().includes(searchQuery.toLowerCase()))));
    }, [
        searchQuery,
        posts
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb35dfa3._.js.map