...
const ColumnVisibilityPage = () => {
  return (
    <>
      ...
      >
        Column visibility controls allow users to show or hide specific columns, customizing their view to focus on the
        most relevant data.
      </motion.p>
      ...
      >
        <p className="text-gray-700 mb-4">
          ...
          <code className="bg-gray-200 px-1 py-0.5 rounded text-gray-800">hide</code> property in the header objects and
          the <code className="bg-gray-200 px-1 py-0.5 rounded text-gray-800">editColumns</code> prop on the SimpleTable
          component.
        </p>
