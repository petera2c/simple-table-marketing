...
const MobileUnsupportedPage: React.FC<{ featureName: string }> = ({ featureName }) => {
  return (
    <>
      <SEO
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col items-center justify-center p-8 min-h-[60vh] text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-4">{featureName} is only available on desktop</h1>

          <p className="text-gray-600 mb-8 max-w-md">
            The {featureName} requires a larger screen for the best experience. Please visit this page on a desktop
            device to access all features.
          </p>
